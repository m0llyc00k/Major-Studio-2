...
// d3.json('https://raw.githubusercontent.com/m0llyc00k/Thesis-2022/main/counties_simple_mainland.json')

// d3.json('https://raw.githubusercontent.com/m0llyc00k/Thesis-2022/main/gz_2010_us_050_00_500k.json')

d3.json('https://raw.githubusercontent.com/m0llyc00k/Thesis-2022/main/mainland_counties.json')
  .then((geojson) => {
    ...
    let featureElement = svg
      ...
      .attr("fill", function (d) {
        return myColor(d.properties.MAT)
      })
      ...
      .on('mouseover', function (d) {
        ...
        //add hover to name
        d3.select('#hover')
          .text(d.srcElement.__data__.properties.NAMELSAD + ' has ' + (d.srcElement.__data__.properties.MAT) + ' centers')
