  ...
  var links = svg
   ...
   .attr('d', d => {
    ...
    return ['M', start, 50, // the arc starts at the coordinate x=start, y=height-30 (where the starting node is)
     ...
     (start) / 20, ',', // Next 2 lines are the coordinates of the inflexion point. Height of this point is proportional with start - end distance
     (start - end) / 20, 0, 0, ',',
     end < start ? 0 : 0, start-100, ',', 0
