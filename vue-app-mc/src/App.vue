<template>
	<div class="main">
		<div class="content">
			<div id="mobile-background">
				<div id="mobile-message">
					<div class="m-text m-text-title">Thank you for visiting In Crisis, Again!</div>
					<div class="m-text">
		...
		<div id="desktop">
			<div id="app">
				<Scrollama :offset="0.85" @step-enter="pillHandler" @step-exit="resetContent">
					<div class="intro">
						<div id="intro-title">
							<h1 id="in-crisis">In Crisis, Again</h1>
							<h2 id="sub-title">
								Understanding the Endurance of Opioids &<br />Combatting the Modern American
								Epidemic
							</h2>
							<br />
				...
				<div>
					<Scrollama :offset="0.5" @step-enter="handler">
						...
						<div class="step step-app">
							<div class="app-text">
								<p class="para-text">
									Over a century before the mis-marketing of OxyContin dominated news outlets, the
									nation faced its first widespread opioid epidemic.
									<br /><br />
									The emergence, exploitation, and eruption of both epidemics follow the same arcs
									in history, yet the de-escalation of the 19th century epidemic has faded into
									distant memory and recovery from the most recent has yet to be seen.
								</p>
							</div>
						</div>
						<!-- <div class="step step-app">
									...
									<div class="resource-box">
										<div id="outro-title" class="resource-group">
											<p>
												...
												inaccessibility of MAT leaves the nation crippled with little chance of
												recovery.
											</p>
											...
											<p>
												...
												<span class="emphasize-color">understanding</span> the onset of the first
												opioid epidemic and the stigma it left behind,
												<span class="emphasize-color">sympathizing</span> with the physiology of
												addiction, and
												<span class="emphasize-color">making MAT treatment accessible.</span>
											</p>
										</div>
									</div>
								</div>
...
export default {
	...
	methods: {
		...
		handler({ element, index, direction }) {
			...
			if (index === 0) this.stackedFall(), d3.selectAll('.restack-pill').attr('opacity', 0);
...
.app-text {
	...
	box-shadow: 0 2.8px 2.2px rgba(0, 0, 0, 0.134), 0 6.7px 5.3px rgba(0, 0, 0, 0.048),
		0 12.5px 10px rgba(0, 0, 0, 0.16), 0 22.3px 17.9px rgba(0, 0, 0, 0.072),
		0 41.8px 33.4px rgba(0, 0, 0, 0.086), 0 100px 80px rgba(0, 0, 0, 0.25);
}
